<?php
    ...
    $emailCheckQuery = "SELECT email, salt, hash, experience FROM players WHERE email = '$email'";
    ...
    $updatequery = "UPDATE players SET experience = " . $newexperience . " WHERE username = '" . $username . "';";
